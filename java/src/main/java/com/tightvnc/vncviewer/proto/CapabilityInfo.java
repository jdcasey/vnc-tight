...
public class CapabilityInfo
{
    ...
    public CapabilityInfo( final int code, final String vendorSignature, final String nameSignature,
    ...
    public CapabilityInfo( final int code, final byte[] vendorSignature, final byte[] nameSignature )
    {
        this.code = code;
    ...
    public boolean equals( final CapabilityInfo other )
    {
    ...
    public boolean enableIfEquals( final CapabilityInfo other )
    {
