    ...
    implements WindowListener, ActionListener
{
    ...
    public RecordingFrame( final VncViewer v )
    {
        ...
        final String fname =
            nextNewFilename( System.getProperty( "user.dir" ) + System.getProperty( "file.separator" )
                + "vncsession.fbs" );
        ...
        final Label helpLabel = new Label( "File name to save next recorded session in:", Label.CENTER );
    ...
    {
        final File currentFile = new File( fnameField.getText() );

        final FileDialog fd = new FileDialog( this, "Save next session as...", FileDialog.SAVE );
