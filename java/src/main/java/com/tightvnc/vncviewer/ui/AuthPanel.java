    ...
    implements ActionListener
{
    ...
    public AuthPanel( final VncViewer viewer )
    {
        final Label titleLabel = new Label( "VNC Authentication", Label.CENTER );
        titleLabel.setFont( new Font( "Helvetica", Font.BOLD, 18 ) );

        final Label promptLabel = new Label( "Password:", Label.CENTER );
