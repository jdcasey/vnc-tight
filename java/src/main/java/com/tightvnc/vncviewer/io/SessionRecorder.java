...
public class SessionRecorder
{
    ...
    public SessionRecorder( final String name, final int bufsize )
        throws IOException
    {
    ...
    public SessionRecorder( final String name )
        throws IOException
    {
        this( name, 65536 );
    }
    ...
    public void writeShortBE( final int v )
        throws IOException
    {
        prepareWriting();
    ...
    public void writeIntBE( final int v )
        throws IOException
    {
        prepareWriting();
    ...
    public void writeShortLE( final int v )
        throws IOException
    {
        prepareWriting();
        buffer[bufferBytes++] = (byte) v;
    ...
    public void writeIntLE( final int v )
        throws IOException
    {
        prepareWriting();
        buffer[bufferBytes] = (byte) v;
    ...
    public void flush( final boolean updateTimeOffset )
        throws IOException
    {
        if ( bufferBytes > 0 )
        {
